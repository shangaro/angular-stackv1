...
@Component({
    selector:'fw-trigger-dropoff-form',
    templateUrl:'./trigger-dropoff-release-form.component.html',
    styleUrls:['./trigger-dropoff-release-form.component.css']
})
export class TriggerDropOffReleaseFormComponent{
    public releaseCodes:string[]=[
